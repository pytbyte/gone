...
@accounts_bp.route('/login_user',endpoint='login', methods=('GET', 'POST'))
def login():
...
@accounts_bp.route('/update',endpoint='update_user', methods=('GET', 'PUT'))
@jwt_required
def update_user():
...
@accounts_bp.route('/profile_pic', endpoint='upload_prof_pic', methods=('GET', 'POST'))
@jwt_required
def upload_prof_pic():
    """
...
@accounts_bp.route('/follow', endpoint='follow_user', methods=('GET', 'POST'))
...
@accounts_bp.route('/unfollow',endpoint='unfollow_user', methods=('GET', 'POST'))
...
@accounts_bp.route('/followers', endpoint='get_followers',methods=('GET','POST'))
@jwt_required
def get_followers():
    data = request.json
    user_id = data.get('user_id')
...
@accounts_bp.route('/following', endpoint='get_following', methods =("GET","POST") )
@jwt_required
def get_following():
    flwn = []
    data = request.json
...
@accounts_bp.route("/users", endpoint='all_users', methods =("GET","POST"))
def all_users():
    user_data=[]
...
@accounts_bp.route('/user', endpoint='get_user', methods=('GET', 'POST'))
@jwt_required
def get_user():
...
@accounts_bp.route('/my_protofolio', endpoint='protofolio', methods=('GET', 'POST'))
@jwt_required
def protofolio():
    #definations 
    data = request.json
...
@accounts_bp.route('/delete_users',endpoint='delete_account', methods=( 'GET','POST'))
@jwt_required
def delete_account():
    """
...
@accounts_bp.route('/interests', endpoint='create_category',  methods=('GET', 'POST'))
@jwt_required
def create_category():
    data = request.json
    user_id = data.get("user_id")
...
@accounts_bp.route('/edit_interest', endpoint='update_category', methods=('GET', 'PUT'))
@jwt_required
def update_category():
    data= request.json
...
""" 
@accounts_bp.route('/get_interests', endpoint='get_interests', methods=('GET', 'POST'))
@jwt_required
def get_interests():
    inter =[]
...
""" 
@accounts_bp.route('/get_proffessions', endpoint='get_proffessions',  methods=('GET', 'POST'))
@jwt_required
...
@accounts_bp.route('/search', endpoint='search', methods=('GET', 'POST'))
@jwt_required
def search():
    data= request.json
...
@accounts_bp.route("/timeline", methods=('GET','POST'))
@jwt_required
def timeline():
   data = request.json
   user_id = data.get("user_id")
...
""" 
@accounts_bp.route('/all_notifications',  methods=('GET', 'POST'))
@jwt_required
...
""" 
@accounts_bp.route('/my_notifications',  methods=('GET', 'POST'))
@jwt_required
...
""" 
@accounts_bp.route('/single_notification',  methods=('GET', 'POST'))
@jwt_required
...
""" 
@accounts_bp.route('/read_all', methods=('GET', 'POST'))
@jwt_required
def read_all():
    data = request.json
